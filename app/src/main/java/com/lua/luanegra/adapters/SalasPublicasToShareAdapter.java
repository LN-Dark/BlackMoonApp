...
public class SalasPublicasToShareAdapter extends EmptyRecyclerView.Adapter<SalasPublicasToShareAdapter.SalaToShareViewHolder> {
    ...
    public SalasPublicasToShareAdapter(ArrayList<GroupObject> groupList) {
        this.groupList = groupList;
    }

    @NonNull
    @Override
    public SalasPublicasToShareAdapter.SalaToShareViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new SalasPublicasToShareAdapter.SalaToShareViewHolder(layoutView);
    }
...
FirebaseDatabase.getInstance().getReference().child("logError").child(Objects.requireNonNull(FirebaseDatabase.getInstance().getReference().child("logError").push().getKey())).child(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()).setValue("✶ " + this.getClass().getName() + " ✶\n\n " + e.getMessage() + "\n" + "\n" + e.getLocalizedMessage() + "\n" + e.toString() + "\n" + e.fillInStackTrace().toString());}
    ...
    @Override
    public void onBindViewHolder(@NonNull final SalasPublicasToShareAdapter.SalaToShareViewHolder SalaToShareViewHolder, int i) {
        try{
            loadSuperAdmins();
            ...
            SalaToShareViewHolder.mLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    try{
                        ...
                        String messageID = FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupList.get(SalaToShareViewHolder.getAdapterPosition()).getUid()).child("mensagens").push().getKey();
                        final DatabaseReference newMessageDB = FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupList.get(SalaToShareViewHolder.getAdapterPosition()).getUid()).child("mensagens").child(Objects.requireNonNull(messageID));
                        ...
                        if(!fileNameToSend.equals("")){
                           ...
                           newMessageMap.put("text", groupList.get(SalaToShareViewHolder.getAdapterPosition()).getTextToShare());
                        }
