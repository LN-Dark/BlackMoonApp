...
public class AdminsSalaPrivadaAdapter extends EmptyRecyclerView.Adapter<AdminsSalaPrivadaAdapter.AdminsSalaViewHolder> {
    private final ArrayList<UserObject> userList;
    private DatabaseReference AdminsSalaPrivadaRef;

    public AdminsSalaPrivadaAdapter(ArrayList<UserObject> userList) {
        this.userList = userList;
    }

    @NonNull
    @Override
    public AdminsSalaPrivadaAdapter.AdminsSalaViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new AdminsSalaPrivadaAdapter.AdminsSalaViewHolder(layoutView);
    }

    private static String FCMServer, SinchKey, SinchSecret;

    @Override
    public void onBindViewHolder(@NonNull final AdminsSalaPrivadaAdapter.AdminsSalaViewHolder adminsSalaViewHolder, int i) {
        ...
        mAppKeysRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AdminsSalaPrivadaRef = FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(userList.get(adminsSalaViewHolder.getAdapterPosition()).getSalaPrivadaID());
