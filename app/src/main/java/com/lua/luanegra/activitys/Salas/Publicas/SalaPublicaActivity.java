...
public class SalaPublicaActivity extends AppCompatActivity {
    ...
    private ConstraintLayout layoutSendSMS, layout_sala_publica;
    ...
    private void doBindService() {
        if (bindService(new Intent(SalaPublicaActivity.this, CallService.class),
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        ...
        if (currentTime - previousTime > 7*60*1000){
            menu.findItem(R.id.option_publicas_enviarNotificacao).setVisible(true);
        } else {
            menu.findItem(R.id.option_publicas_enviarNotificacao).setVisible(false);
                            ...
                            if(dataSnapshot2.exists()){
                                if(!dataSnapshot.child("creator").getValue().toString().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                                    ...
                                    if(adminsList.contains(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                                        menu.findItem(R.id.admin_option_sala_publica).setVisible(true);
                                        menu.findItem(R.id.sair_salaPublica_BTN).setVisible(false);
                                    }else {
                                        menu.findItem(R.id.admin_option_sala_publica).setVisible(false);
                                        menu.findItem(R.id.sair_salaPublica_BTN).setVisible(true);
                                    }
                                }
                                if(dataSnapshot2.child("favoritos").exists()){
                                    if(dataSnapshot2.child("favoritos").child(groupUID).exists()){
                                        if(dataSnapshot2.child("favoritos").child(groupUID).getValue().toString().equals("true")){
                                            menu.findItem(R.id.favoritos_salapublica_btn).setIcon(getDrawable(R.drawable.dislike));
                                        }else {
                                            menu.findItem(R.id.favoritos_salapublica_btn).setIcon(getDrawable(R.drawable.ic_like));
                                        }
                                    }
                                }
                            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sala_publica);
        try{
            callMake = findViewById(R.id.entrarCallGrupo);
            layout_sala_publica = findViewById(R.id.layout_chat_sala_publica);
            callMake.setText(R.string.ligar);
            myView = findViewById(R.id.call_menu_salaPublica);
            isClosedView = false;
            ...
            mSend = findViewById(R.id.sendButton_grupoPublica);
            layoutSendSMS = findViewById(R.id.layout_SendSMS_salasPublica);
            ...
            callMake.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!callMake.isChecked()){
                        ...
                        Drawable img = SalaPublicaActivity.this.getDrawable(R.drawable.call);
                        ...
                        Drawable img = SalaPublicaActivity.this.getDrawable(R.drawable.end_call);
                        Objects.requireNonNull(img).setBounds( 0, 0, 60, 60 );
                        callMake.setCompoundDrawables( img, null, null, null );
                        joinChannel();
                        sendMessage();
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        inflater.inflate(R.menu.salas_publicas_options, menu);
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        if(item.getItemId() == R.id.reportar_salapublica_btn){
            final AlertDialog.Builder builder3 = new MaterialAlertDialogBuilder(SalaPublicaActivity.this);
            LinearLayout layout = new LinearLayout(SalaPublicaActivity.this);
            ...
            final EditText textoshare = new EditText(SalaPublicaActivity.this);
            ...
            final TextView espaco5 = new TextView(SalaPublicaActivity.this);
            espaco5.setText(" ");
                            ...
                            if(dataSnapshot.exists()){
                                if(dataSnapshot.child("reportsTemporarios").exists()){
                                    ...
                                    if(flagteste == 0){
                                        ...
                                        FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("reportsTemporarios").child(key).child("creator").setValue(FirebaseAuth.getInstance().getCurrentUser().getUid()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("reportsTemporarios").child(key).child("data").setValue(currentDate).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    @Override
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("reportsTemporarios").child(key).child("hora").setValue(currentTime).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("reportsTemporarios").child(key).child("report").setValue(textoshare.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    @Override
                                                                    public void onComplete(@NonNull Task<Void> task) {
            ...
            onBackPressed();
        }else if(item.getItemId() == R.id.deixar_de_ser_admin_btn_publica){
            final AlertDialog.Builder builder312 = new MaterialAlertDialogBuilder(SalaPublicaActivity.this);
            LinearLayout layout12 = new LinearLayout(SalaPublicaActivity.this);
            ...
            final TextView textoshare12 = new TextView(SalaPublicaActivity.this);
            ...
            final TextView espaco512 = new TextView(SalaPublicaActivity.this);
            espaco512.setText(" ");
            ...
            builder312.setPositiveButton(getResources().getString(R.string.yap), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("admins").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
            ...
            alert12.show();
        }else if(item.getItemId() == R.id.sair_salaPublica_BTN){
            final AlertDialog.Builder builder31 = new MaterialAlertDialogBuilder(SalaPublicaActivity.this);
            LinearLayout layout1 = new LinearLayout(SalaPublicaActivity.this);
            layout1.setOrientation(LinearLayout.VERTICAL);
            builder31.setIcon(getDrawable(R.drawable.luanegra_logo));
            builder31.setTitle(getString(R.string.sairdasalaprivada));
            final TextView textoshare1 = new TextView(SalaPublicaActivity.this);
            ...
            final TextView espaco51 = new TextView(SalaPublicaActivity.this);
            espaco51.setText(" ");
            ...
            builder31.setPositiveButton(getResources().getString(R.string.yap), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            SharedPreferences preferences = getSharedPreferences(groupUID, MODE_PRIVATE);
                            preferences.edit().remove(groupUID).apply();
                            SalaPublicaActivity.this.finish();
                        }
                    });
                }
            });
            ...
            alert1.show();
        }else if(item.getItemId() == R.id.favoritos_salapublica_btn){
            FirebaseDatabase.getInstance().getReference().child("user").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
        ...
        }else if(item.getItemId() == R.id.option_publicas_chamadas){
            if (isClosedView) {
                slideDown(myView);
            } else {
                slideUp(myView);
        ...
        }else if(item.getItemId() == R.id.option_publicas_defenicoes){
            Intent intent = new Intent(SalaPublicaActivity.this, DefenicoesSalaPublicaActivity.class);
            ...
            editor.apply();
            item.setVisible(false);
        }else if(item.getItemId() == R.id.option_publicas_enviarMultimedia){
            openGallery();
        }else if(item.getItemId() == R.id.option_publicas_enviarMeme){
            Intent intent2 = new Intent(SalaPublicaActivity.this, MemesActivity.class);
    ...
    private void GetAdminsList(){
        ...
        FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("admins").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
    ...
    private void EnviarSigaaa() {
        try{
            FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()){
        ...
        FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    mMessage = findViewById(R.id.messageChat_GrupoPublica);
                    ...
                    layout_sala_publica.setBackgroundColor(color);
    ...
    private void RetrieveUsersInCall() {
        try{
            userCallList.clear();
            UserInCallRef = FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("online");
                            ...
                            if(dataSnapshot.exists()){
                                if(dataSnapshot.child("patrono").getValue().toString().equals("true")){
                                    if(Objects.requireNonNull(data).getClipData()== null){
                                        ...
                                        Cursor cursor = SalaPublicaActivity.this.getContentResolver().query(fileUri,
                                                null, null, null, null);
                                        cursor.moveToFirst();
    ...
    private void getChatMessages() {
        try{
            ...
            mChatRef = FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("mensagens");
    ...
    private void sendMessage() {
        try{
            ...
            String messageID = FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("mensagens").push().getKey();
            final DatabaseReference newMessageDB = FirebaseDatabase.getInstance().getReference().child("salasPublicas").child(groupUID).child("mensagens").child(Objects.requireNonNull(messageID));
    ...
    private void InitializeMessage() {
        try{
            ...
            EmptyRecyclerView mChat = findViewById(R.id.messageRecyclerView_GrupoPublica);
    ...
    private void joinChannel() {
        try {
            ...
            mBoundService.StartCall(groupUID,currentGroupName, "salaPublica", SalaPublicaActivity.this);
        }catch (Exception e){
            FirebaseDatabase.getInstance().getReference().child("logError").child(Objects.requireNonNull(FirebaseDatabase.getInstance().getReference().child("logError").push().getKey())).child(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()).setValue("✶ " + this.getClass().getName() + " ✶\n\n " + e.getMessage() + "\n" + "\n" + e.getLocalizedMessage() + "\n" + e.toString() + "\n" + e.fillInStackTrace().toString());}
    }

    private void leaveChannel() {
        mBoundService.EndCall(groupUID, currentGroupName, "salaPublica");
