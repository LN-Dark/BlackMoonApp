...
import com.lua.luanegra.adapters.PedidoDeCriacaoNovasSalasAdapter;
...
public class PedidoCriacaoSalasAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_criacao_salas_admin);
        try{
            Toolbar toolbar = findViewById(R.id.toolbarActivity);
            toolbar.setLogo(getDrawable(R.drawable.luanegra_logo));
            toolbar.setSubtitle("" + getString(R.string.pedidodecriacaodesalasdejogo));
    ...
    protected void onResume() {
        ...
        funcionalidadesRef = FirebaseDatabase.getInstance().getReference().child("pedidoNovasSalas");
            ...
            childEventListener = funcionalidadesRef.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    if (dataSnapshot.exists()){
                        ...
                        logText = dataSnapshot.child("sala").getValue().toString();
    ...
    private void InitializeRecyclerView() {
        try {
            EmptyRecyclerView mLogList = findViewById(R.id.recycler_pedidosCriacaoSala);
            mLogList.setNestedScrollingEnabled(false);
            mLogList.setHasFixedSize(false);
            EmptyRecyclerView.LayoutManager mUserListLayoutManager = new LinearLayoutManager(PedidoCriacaoSalasAdminActivity.this, EmptyRecyclerView.VERTICAL, false);
            mLogList.setLayoutManager(mUserListLayoutManager);
            funcionalidadesListAdapter = new PedidoDeCriacaoNovasSalasAdapter(funcionalidadesList);
