...
public class CoresSalaPrivadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
                    ...
                    btn_cor_apresentacao.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    .with(CoresSalaPrivadaActivity.this)
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            ...
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("apresentacao").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("toolbarSuperior").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("toolbarInferior").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("texto").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("fundo").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("dataHora").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("chatSender").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("chatReciever").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
                        ...
                        public void onClick(final View v) {
                            ...
                            ColorPickerDialogBuilder
                                    ...
                                    .setPositiveButton(getResources().getString(R.string.gravar), new ColorPickerClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int selectedColor, Integer[] allColors) {
                                            String hexColor = String.format("#%06X", (0xFFFFFF & selectedColor));
                                            FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("coresSala").child("barraMensagens").setValue(hexColor).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Snackbar.make(v, getResources().getString(R.string.coralterada), Snackbar.LENGTH_LONG)
                                                            .setAction("Action", null).show();
