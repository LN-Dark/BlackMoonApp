...
public class DefenicoesMainSalaPrivadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SalasPrivadasRef = FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID);
        ...
        trasnferirSala.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DefenicoesMainSalaPrivadaActivity.this, ChangeSalaCreatorActivity.class);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton(getResources().getString(R.string.yap), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).removeValue();
        ...
        readonlybutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!readonlybutton.isChecked()){
                    FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("opcoes").child("readOnly").setValue("false").addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                    ...
                    FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("opcoes").child("readOnly").setValue("true").addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
    ...
    private void SendUserToMainActivity() {
        try{
            Intent mainIntent = new Intent(DefenicoesMainSalaPrivadaActivity.this, MainActivity.class);
    ...
    DatabaseReference SalasPrivadasRef ;
                        ...
                        if(dataSnapshot.exists()){
                            ...
                            if(!listaNomeUtilizadores.contains(setUserName)){
                                if(!dataSnapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("logo").equals(profileImage)){
                                    ...
                                    String mediaID = SalasPrivadasRef.child("logo").push().getKey();

                                    final StorageReference filePath = FirebaseStorage.getInstance().getReference().child("SalasPrivadas").child(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()).child(Objects.requireNonNull(mediaID));
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    SalasPrivadasRef.child("logo").setValue(uri.toString());
                                    ...
                                    SalasPrivadasRef.child("nome").setValue(setUserName).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            SalasPrivadasRef.child("descricao").setValue(setBIO).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    progressDialog.cancel();
