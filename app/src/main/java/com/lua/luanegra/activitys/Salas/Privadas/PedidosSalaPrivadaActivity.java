...
import com.lua.luanegra.adapters.PedidosSalaPrivadaAdapter;
...
public class PedidosSalaPrivadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedidos_sala_privada);
    ...
    private void InitializeRecyclerView() {
        try {
            EmptyRecyclerView mUserList = findViewById(R.id.pedidos_salaPrivada_recycler);
            ...
            mUserListAdapter = new PedidosSalaPrivadaAdapter(listaUsersSala);
