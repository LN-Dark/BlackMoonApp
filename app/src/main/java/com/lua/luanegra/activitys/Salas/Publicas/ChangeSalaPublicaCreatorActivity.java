...
import com.lua.luanegra.adapters.ChangeCreatorSalaPublicaAdapter;
...
public class ChangeSalaPublicaCreatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_sala_publica_creator);
    ...
    private void InitializeRecyclerView() {
        try {
            EmptyRecyclerView mUserList = findViewById(R.id.changeCreator_salaPublica_recycler);
            ...
            mUserListAdapter = new ChangeCreatorSalaPublicaAdapter(listaUsersSala);
