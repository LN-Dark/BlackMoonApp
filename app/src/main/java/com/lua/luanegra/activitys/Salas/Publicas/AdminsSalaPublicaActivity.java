...
import com.lua.luanegra.adapters.AdminsSalaPublicaAdapter;
...
public class AdminsSalaPublicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admins_sala_publica);
    ...
    private void InitializeRecyclerView() {
        try {
            EmptyRecyclerView mUserList = findViewById(R.id.admins_salaPublica_recycler);
            ...
            mUserListAdapter = new AdminsSalaPublicaAdapter(listaUsersSala);
