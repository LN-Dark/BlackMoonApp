...
import com.lua.luanegra.adapters.BloquedUserSalaPrivadaAdapter;
...
public class BloquearUserSalaPrivadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bloquear_user_sala_privada);
    ...
    private void InitializeRecyclerView() {
        try {
            EmptyRecyclerView mUserList = findViewById(R.id.bloquearUsers_salaPrivada_recycler);
            ...
            mUserListAdapter = new BloquedUserSalaPrivadaAdapter(listaUsersSala);
