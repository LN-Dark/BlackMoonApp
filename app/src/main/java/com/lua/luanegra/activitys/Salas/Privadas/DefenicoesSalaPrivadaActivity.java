...
public class DefenicoesSalaPrivadaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defenicoes_sala_privada);
        ...
        final MaterialButton coresBtn = findViewById(R.id.btn_cores_sala_privada);
        MaterialButton bloquearBtn = findViewById(R.id.btn_bloquearuser_sala_privada);
        MaterialButton pedidosBtn = findViewById(R.id.btn_pedidos_sala_privada);
        final MaterialButton defCreatorSala = findViewById(R.id.btn_defCreator_sala_privada);
        final MaterialButton adminsBtn = findViewById(R.id.btn_admins_sala_privada);
        ...
        btn_verificar_Sala.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout layout = new LinearLayout(DefenicoesSalaPrivadaActivity.this);
                ...
                final TextInputEditText textoshare = new TextInputEditText(DefenicoesSalaPrivadaActivity.this);
                ...
                final TextInputEditText espaco5 = new TextInputEditText(DefenicoesSalaPrivadaActivity.this);
                espaco5.setText(" ");
                        ...
                        FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if(dataSnapshot.exists()){
                                    FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("users").child(dataSnapshot.child("verifiRequest").child("admin").getValue().toString()).setValue(true);
                                    ...
                                    FirebaseDatabase.getInstance().getReference().child("appKeys").addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            if(dataSnapshot.exists()){
                                                ...
                                                sendNotification.sendNotification(notification, DefenicoesSalaPrivadaActivity.this, dataSnapshot.child("serverFCM").getValue().toString());
                                                Snackbar.make(findViewById(android.R.id.content), getString(R.string.chavedeacessoenviada), Snackbar.LENGTH_LONG)
                                                        .setAction("Action", null).show();
                                                FirebaseDatabase.getInstance().getReference().child("salasPrivadas").child(groupUID).child("verifiRequest").child("auto").setValue("true");
                                            }
                                        }
        ...
        defCreatorSala.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefenicoesSalaPrivadaActivity.this, DefenicoesMainSalaPrivadaActivity.class);
        ...
        coresBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefenicoesSalaPrivadaActivity.this, CoresSalaPrivadaActivity.class);
                intent.putExtra("groupUID", groupUID);
                intent.putExtra("groupName", currentGroupName);
                startActivity(intent);
            }
        ...
        adminsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefenicoesSalaPrivadaActivity.this, AdminsSalaPrivadaActivity.class);
                intent.putExtra("groupUID", groupUID);
                intent.putExtra("groupName", currentGroupName);
                startActivity(intent);
            }
        ...
        bloquearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefenicoesSalaPrivadaActivity.this, BloquearUserSalaPrivadaActivity.class);
                intent.putExtra("groupUID", groupUID);
                intent.putExtra("groupName", currentGroupName);
                startActivity(intent);
            }
        ...
        pedidosBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DefenicoesSalaPrivadaActivity.this, PedidosSalaPrivadaActivity.class);
                intent.putExtra("groupUID", groupUID);
                intent.putExtra("groupName", currentGroupName);
                startActivity(intent);
            }
